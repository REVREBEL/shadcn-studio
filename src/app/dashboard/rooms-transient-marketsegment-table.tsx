...
export default function RoomstransientTable() {
  ...
  const columns = [
    ...
    columnHelper.accessor('rooms', {
      header: ({ column }) => <DataGridColumnHeader title='Rooms' column={column} />,
    ...
    columnHelper.accessor('varSTLY', {
      header: ({ column }) => <DataGridColumnHeader title='Var  STLY' column={column} />,
      cell: ({ getValue }) => <div>{getValue().toLocaleString()}</div>,
      size: 180,
      enableSorting: true,
      enableHiding: true,
    ...
    columnHelper.accessor('varPriorYear', {
      header: ({ column }) => <DataGridColumnHeader title='Var  Prior Year' column={column} />,
      cell: ({ getValue }) => <div>{getValue().toLocaleString()}</div>,
      size: 180,
      enableSorting: true,
      enableHiding: true,
    ...
    columnHelper.accessor('varBudget', {
      header: ({ column }) => <DataGridColumnHeader title='Var Budget' column={column} />,
      cell: ({ getValue }) => <div>{getValue().toLocaleString()}</div>,
      size: 180,
      enableSorting: true,
      enableHiding: true,
    ...
    columnHelper.accessor('varForecast', {
      header: ({ column }) => <DataGridColumnHeader title='Var Forecast' column={column} />,
      cell: ({ getValue }) => <div>{getValue().toLocaleString()}</div>,
      size: 180,
      enableSorting: true,
      enableHiding: true,
  ...
  const filterFields = useMemo<FilterFieldConfig[]>(
    () => [
      ...
      },
      {
        ...
        label: 'occpuancy',
        type: 'number',
        placeholder: 'Filter by occpuancy...'
      },
      {
        key: 'rooms',
        label: 'rooms',
    ...
    >
      <div className='w-full space-y-2.5'>
        ...
        <div className='flex-1'>
          <Filters filters={filters} fields={filterFields} variant='outline' onChange={handleFiltersChange} />
        </div>
        {filters.length > 0 && (
